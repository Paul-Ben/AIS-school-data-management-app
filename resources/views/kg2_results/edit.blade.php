...
@section('content')
    <div class="container mt-2">
        ...
        @endif
        <form action="{{ route('updateKg1Result', $result->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><h4>Assesment Scores</h4></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="score"  name="subject1_assessment" id="s1_ca1" size="4" oninput="checkValue()" maxlength="2" value="{{$result->subject1_assessment}}" required ></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject1_exam" id="s1_exam" size="4" maxlength="2" value="{{$result->subject1_exam}}" required></td>
                        <td><input type="text" name="subject1_overall" id="s1_overall" onfocus="calcOverall()" value="{{$result->subject1_overall}}" size="4" maxlength="3"></td>
                        <td><input type="text" name="subject1_grade" id="s1_grade" size="4" value="{{$result->subject1_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject2_assessment" id="s2_ca1" size="4" value="{{$result->subject2_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject2_exam" id="s2_exam" size="4" value="{{$result->subject2_exam}}" maxlength="2" required></td>
                        <td><input type="text" name="subject2_overall" id="overall2" onfocus="calcOverall2()" size="4" value="{{$result->subject2_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject2_grade" id="s2_grade" size="4" value="{{$result->subject2_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject3_assessment" id="s3_ca1" size="4" value="{{$result->subject3_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject3_exam" id="s3_exam" size="4" value="{{$result->subject3_exam}}" maxlength="2" required></td>
                        <td><input type="text" name="subject3_overall" id="overall3" onfocus="calcOverall3()" size="4" value="{{$result->subject3_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject3_grade" id="s3_grade" size="4" value="{{$result->subject3_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject4_assessment" id="s4_ca1" size="4" value="{{$result->subject4_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject4_exam" id="s4_exam" size="4" maxlength="2" value="{{$result->subject4_exam}}" required></td>
                        <td><input type="text" name="subject4_overall" id="overall4" onfocus="calcOverall4()" size="4" value="{{$result->subject4_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject4_grade" id="s4_grade" size="4" value="{{$result->subject4_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject5_assessment" id="s5_ca1" size="4" value="{{$result->subject5_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject5_exam" id="s5_exam" size="4" value="{{$result->subject5_exam}}" maxlength="2" required></td>
                        <td><input type="text" name="subject5_overall" id="overall5" onfocus="calcOverall5()" size="4" value="{{$result->subject5_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject5_grade" id="s5_grade" size="4" value="{{$result->subject5_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject6_assessment" id="s6_ca1" size="4" value="{{$result->subject6_assessment}}" maxlength="2" required ></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject6_exam" id="s6_exam" size="4" maxlength="2" value="{{$result->subject6_exam}}" required></td>
                        <td><input type="text" name="subject6_overall" id="overall6" onfocus="calcOverall6()" size="4" value="{{$result->subject6_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject6_grade" id="s6_grade" size="4" value="{{$result->subject6_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject7_assessment" id="s7_ca1" size="4" value="{{$result->subject7_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject7_exam" id="s7_exam" size="4" maxlength="2" value="{{$result->subject7_exam}}" required></td>
                        <td><input type="text" name="subject7_overall" id="overall7" onfocus="calcOverall7()" size="4" value="{{$result->subject7_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject7_grade" id="s7_grade" size="4" value="{{$result->subject7_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject8_assessment" id="s8_ca1" size="4" value="{{$result->subject8_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject8_exam" id="s8_exam" size="4" value="{{$result->subject8_exam}}" maxlength="2" required></td>
                        <td><input type="text" name="subject8_overall" id="overall8" onfocus="calcOverall8()" size="4" value="{{$result->subject8_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject8_grade" id="s8_grade" size="4" value="{{$result->subject8_grade}}" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject9_assessment" id="s9_ca1" size="4" value="{{$result->subject9_assessment}}" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                        <td><input type="text" name="subject9_exam" id="s9_exam" size="4" value="{{$result->subject9_exam}}" maxlength="2" required></td>
                        <td><input type="text" name="subject9_overall" id="overall9" onfocus="calcOverall9()" size="4" value="{{$result->subject9_overall}}" maxlength="3"></td>
                        <td><input type="text" name="subject9_grade" id="s9_grade" size="4" value="{{$result->subject9_grade}}" maxlength="1"></td>
                        <td>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="teachers_comments" class="form-control" placeholder="Teacher's Comment" value="{{$result->teachers_comments}}" required>
                            @error('teachers_comments')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                            @if (Session::has('message'))
                                <div class="alert alert-info">{{ Session::get('message') }}</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="head_teachers_comments" class="form-control" value="{{$result->head_teachers_comments}}" placeholder="Teacher's Comment"  required>
                            @error('head_teachers_comments')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                            @if (Session::has('message'))
                                <div class="alert alert-info">{{ Session::get('message') }}</div>
    ...
    <script src="{{asset('/assets/styles/result/kg1_results.js')}}"></script>
