...
<body>
    ...
    <div id="print">
            ...
            <div class="row">
                ...
                <table  class="table rounded-lg " style="border: solid black 1px;">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><h4>Assessment Scores</h4></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject1_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject2_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject3_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject4_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject5_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject6_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject7_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject8_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td> </td>
                        <td class="p-3">{{ $results->subject9_assessment }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                    ...
                    <tr>
                        ...
                        <td><h5>{{floatval($results->subject1_overall)+floatval($results->subject2_overall)+floatval($results->subject3_overall)+floatval($results->subject4_overall)+floatval($results->subject5_overall)+floatval($results->subject6_overall)+floatval($results->subject7_overall)+floatval($results->subject8_overall)+floatval($results->subject9_overall)}}<h5></td>
                        <td></td>
                        <td colspan="2"><h5>Out of: </h5> </td>
                        <td><h5>900</h5></td>
                        <td ><h5>Average: </h5></td>
                        <td colspan="2"><h5>{{ round((floatval($results->subject1_overall)+floatval($results->subject2_overall)+floatval($results->subject3_overall)+floatval($results->subject4_overall)+floatval($results->subject5_overall)+floatval($results->subject6_overall)+floatval($results->subject7_overall)+floatval($results->subject8_overall)+floatval($results->subject9_overall))/9,2)}}</h5></td>
                        {{-- <td class="p-3"></td> --}}
                    </tr>
                    <tr>
                        <td><strong>School Days</strong></td>
                        <td> {{ $results->no_of_school_days }}</td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                        <td class="p-3"></td>
                        <td class="p-3" width="20%"><strong>Days Absent</strong></td>
                        <td class="p-3">{{ $results->no_days_absent }}</td>
                        <td class="p-3"></td>
        ...
        <table class="table">
            <tr>
                <td width="20%"><strong>Class Teachers comment:</strong></td>
                <td>{{ $results->teachers_comments}}</td>
                <td width="10%"><strong>Signature:</strong></td>
                <td width="10%">_____________________</td>
            </tr>
            <tr>
                <td></td>
                <td></td>
            ...
            <tr>
                <td width="20%"><strong>Head Teachers comment: </strong></td>
                <td>{{ $results->head_teachers_comments}}</td>
                <td width="10%"><strong>Signature:</strong></td>
                <td width="10%">_____________________</td>
            </tr>
        </table>
                ...
                {{-- <div class="col-xs-12 col-sm-12 border col-md-6">
                    <pre><strong>Class Teachers comment: <u>{{ $results->teachers_comments}}</u></strong></pre>

                </div>
                <div class="col-xs-12 col-sm-12 border col-md-6">
                    <pre><strong>Head Teachers comment:  <u>{{ $results->head_teachers_comments}}</u></strong></pre>
