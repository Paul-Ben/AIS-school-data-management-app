            ...
            <div class="row">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="score"  name="subject1_assessment" id="s1_ca1" size="4" oninput="checkValue()" maxlength="2" required ></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject2_assessment" id="s2_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject3_assessment" id="s3_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject4_assessment" id="s4_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject5_assessment" id="s5_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject6_assessment" id="s6_ca1" size="4" maxlength="2" required ></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject7_assessment" id="s7_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject8_assessment" id="s8_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject9_assessment" id="s9_ca1" size="4" maxlength="2" required></td>
                        <td></td>
                        <td></td>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="teachers_comments" class="form-control" placeholder="Teacher's Comment"  required>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="head_teachers_comments" class="form-control" placeholder="Teacher's Comment"  required>
