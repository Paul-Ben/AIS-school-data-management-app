            ...
            <div class="row">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject9_1st_ca" id="s9_ca1" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject9_2nd_ca" id="s9_ca2" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject9_project" id="s9_pjkt" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject9_exam" id="s9_exam" size="4" maxlength="2" ></td>
                        ...
                        <td>
                            <input type="text" name="subject9_remarks" id="sub9_rmks" size="9"   >
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject10_1st_ca" id="s10_ca1" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject10_2nd_ca" id="s10_ca2" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject10_project" id="s10_pjkt" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject10_exam" id="s10_exam" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject10_overall" id="overall10" onfocus="calcOverall10()" size="4" maxlength="3"></td>
                        <td><input type="text" name="subject10_Grade" id="s10_grade" size="4" maxlength="1"></td>
                        <td>
                            <input type="text" name="subject10_remarks" id="sub10_rmks" size="9"   >
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject11_1st_ca" id="s11_ca1" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject11_2nd_ca" id="s11_ca2" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject11_project" id="s11_pjkt" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject11_exam" id="s11_exam" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject11_overall" id="overall11" onfocus="calcOverall11()" size="4" maxlength="3"></td>
                        <td><input type="text" name="subject11_Grade" id="s11_grade" size="4" maxlength="1"></td>
                        <td>
                            <input type="text" name="subject11_remarks" id="sub11_rmks" size="9"   >
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject12_1st_ca" id="s12_ca1" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject12_2nd_ca" id="s12_ca2" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject12_project" id="s12_pjkt" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject12_exam" id="s12_exam" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject12_overall" id="overall12" onfocus="calcOverall12()" size="4" maxlength="3"></td>
                        <td><input type="text" name="subject12_Grade" id="s12_grade" size="4" maxlength="1"></td>
                        <td>
                            <input type="text" name="subject12_remarks" id="sub12_rmks" size="9"   >
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject13_1st_ca" id="s13_ca1" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject13_2nd_ca" id="s13_ca2" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject13_project" id="s13_pjkt" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject13_exam" id="s13_exam" size="4" maxlength="2" ></td>
                        <td><input type="text" name="subject13_overall" id="overall13" onfocus="calcOverall13()" size="4" maxlength="3"></td>
                        <td><input type="text" name="subject13_Grade" id="s13_grade" size="4" maxlength="1"></td>
                        <td>
                            <input type="text" name="subject13_remarks" id="sub13_rmks" size="9"   >
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_of_school_days"  size="4" maxlength="4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_days_absent"  size="4" maxlength="4">
