            ...
            <div class="row">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject1_exam" id="s1_overall"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject1_grade" id="s1_grade" onfocus="calcOverall()" size="4"maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject2_exam" id="overall2"  size="4" maxlength="3"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject3_exam" id="overall3"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject3_grade" id="s3_grade" onfocus="calcOverall3()" size="4" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject4_exam" id="overall4"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject4_grade" id="s4_grade" onfocus="calcOverall4()" size="4" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject5_exam" id="overall5"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject5_grade" id="s5_grade" onfocus="calcOverall5()" size="4" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject6_exam" id="overall6"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject6_grade" id="s6_grade" onfocus="calcOverall6()" size="4" maxlength="1"></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="subject7_exam" id="overall7"  size="4" maxlength="3"></td>
                        <td><input type="text" name="subject7_grade" id="s7_grade"  onfocus="calcOverall7()" size="4" maxlength="1"></td>
                        <td>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="no_of_days_absent"  size="4" maxlength="4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="teachers_comment" class="form-control" placeholder="Teacher's Comment"  required>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="head_teachers_comment" class="form-control" placeholder="Teacher's Comment"  required>
