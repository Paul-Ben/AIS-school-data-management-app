...
class Kg2_result extends Model
{
    use HasFactory;
    ...
    'subject1_remarks','subject2', 'subject2_assessment', 'subject2_exam', 'subject2_overall', 'subject2_grade', 
    'subject2_remarks', 'subject3', 'subject3_assessment', 'subject3_exam', 'subject3_overall',
     ...
     'subject9_grade', 'subject9_remarks', 'punctuality', 'neatness', 'mental_ability', 'cooperation_with_others', 'attentiveness',
     'speak_out', 'memory_work', 'attitude_to_schoolwork','response_to_homework', 'sports','no_of_school_days', 'no_days_absent', 
     'teachers_comments', 'head_teachers_comments' ];
}
